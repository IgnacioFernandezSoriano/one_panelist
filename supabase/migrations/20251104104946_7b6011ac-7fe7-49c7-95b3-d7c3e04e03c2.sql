-- Update calculate_network_health to accept carrier and product filters
CREATE OR REPLACE FUNCTION public.calculate_network_health(
...
-- Update get_route_performance to accept carrier and product filters
...
RETURNS TABLE(
  nodo_origen character varying, 
  nodo_destino character varying, 
  ciudad_origen character varying, 
  ciudad_destino character varying, 
  clasificacion_origen character varying, 
  clasificacion_destino character varying, 
...
-- Update get_performance_trends to accept carrier and product filters
...
-- Update calculate_sla_compliance to accept carrier and product filters
CREATE OR REPLACE FUNCTION public.calculate_sla_compliance(
  p_cliente_id integer, 
  p_start_date date, 
  p_end_date date,
  p_carrier_id integer DEFAULT NULL,
...
-- Update analyze_issues to accept carrier and product filters
CREATE OR REPLACE FUNCTION public.analyze_issues(
  p_cliente_id integer, 
  p_start_date date, 
  p_end_date date,
  p_carrier_id integer DEFAULT NULL,
